...
def plan_dopamine(c, w, h):
    pn = front_matter(c, w, h, ["THE DOPAMINE", "MENU"],
        ...
        [("The menu", "Five courses, filled in by you, on pages 5–6."),
...
PRODUCTS4 = {
    ...
    "cozy": {
        ...
        "badge": "COZY  ·  49 SPACES  ·  SOFT LINES",
    ...
    "botanical": {
        ...
        "badge": "FINE LINE  ·  49 PLATES  ·  HERBARIUM",
    ...
    "celestial": {
        ...
        "badge": "CELESTIAL  ·  49 PLATES  ·  REAL STAR DATA",
    ...
    "tidal": {
        ...
        "badge": "OCEANCORE  ·  49 PLATES  ·  FINE LINE",
...
def main():
    ...
    for key in build_list:
        ...
        B.generate_wrap(d / f"{p['dir']}_cover_wrap.pdf", p["trim"], pages, tex,
                        p["title_lines"], p["subtitle"], B.back_blurb(p["desc"]), p["features"], ppi)
