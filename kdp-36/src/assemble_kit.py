...
def lookbook(dest: Path, front_pngs: list[tuple[dict, Path]]):
    ...
    c.setFont("Sans", 8)
    c.drawCentredString(4.25 * inch, 8.4 * inch, "K D P   C O M P L E T E   K I T")
    ...
    c.drawCentredString(4.25 * inch, 7.2 * inch, "Interiors, wrap covers, and listing copy — ready to upload")
    c.setFont("Sans", 8)
    c.drawCentredString(4.25 * inch, 1.4 * inch, "Vol 1: 18 core journals     Vol 2: 18 premium companions")
    c.drawCentredString(4.25 * inch, 1.15 * inch, "Undated  ·  Grayscale interiors  ·  Discreet giftable covers")
    c.showPage()
