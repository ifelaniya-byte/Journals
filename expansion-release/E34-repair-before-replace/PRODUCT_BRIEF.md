...
|---|---|
| Primary niche | household repair planning |
| Core customer job | Help users track nontechnical repair decisions and product lifespan |
| Product form under test | 7x9 guided decision workbook |
| Route in this package | direct-first prototype |
| Prototype trim | 7 x 9 in. |
| Prototype pages | 88 |
| Differentiation hypothesis | Item history repair-question page service-contact log and replacement reflection |
| First validation test | Test a household appliance/furniture sample without instructions |

## Original page architecture

- Opening pages: prototype boundary, customer-use orientation, and a product-specific starting map.
- Repeating sequence: **Repair-before-replace decision** entry -> **repair record** work surface -> return note.
- Closing pages: open notes for the user’s own material.

## Boundary

No repair safety electrical plumbing warranty or professional advice
