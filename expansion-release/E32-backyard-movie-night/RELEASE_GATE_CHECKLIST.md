...
- [x] Product-specific boundary is documented: No electrical weather crowd-safety or licensing advice
...
**Limited 2026-08-31 web-screen result:** **COUNSEL REVIEW REQUIRED** - Backyard movie-night event/rental uses are common; title remains a review item.
