# E18 - The First Project Companion

## Local prototype status

**LOCAL PROTOTYPE PACKAGE - HOLD - NOT FOR SALE, UPLOAD, OR MANUFACTURE**
...
|---|---|
| Primary niche | beginner craft projects |
| Core customer job | Keep new hobbyists oriented across a first project without teaching a restricted method |
| Product form under test | 7x9 guided project book |
| Route in this package | paperback prototype |
| Prototype trim | 7 x 9 in. |
| Prototype pages | 88 |
| Differentiation hypothesis | Skill vocabulary in the maker’s own words materials log and restart map |
| First validation test | Test needlepoint crochet and pottery cohorts separately; no borrowed patterns |

## Original page architecture

- Opening pages: prototype boundary, customer-use orientation, and a product-specific starting map.
- Repeating sequence: **First-project session** entry -> **project path** work surface -> return note.
- Closing pages: open notes for the user’s own material.

## Boundary

No professional instruction safety certification or outcome claims
...
**Author shown in prototype:** Arden Vellor
