...
|---|---|
| Primary niche | personal projects |
| Core customer job | Help users maintain an original project arc without hustle framing |
| Product form under test | 7x9 guided workbook |
| Route in this package | paperback prototype |
| Prototype trim | 7 x 9 in. |
| Prototype pages | 96 |
| Differentiation hypothesis | Project premise milestones friction log weekly studio dates and finish archive |
| First validation test | Test one twelve-week sample with maker communities |

## Original page architecture

- Opening pages: prototype boundary, customer-use orientation, and a product-specific starting map.
- Repeating sequence: **Studio week** entry -> **milestone arc** work surface -> return note.
- Closing pages: open notes for the user’s own material.

## Boundary

No achievement productivity or therapeutic outcome claims
