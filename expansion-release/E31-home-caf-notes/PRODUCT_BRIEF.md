...
|---|---|
| Primary niche | home café hobby |
| Core customer job | Document non-alcoholic drink experiments and home-coffee rituals |
| Product form under test | 7x9 recipe and ritual book |
| Route in this package | paperback prototype |
| Prototype trim | 7 x 9 in. |
| Prototype pages | 88 |
| Differentiation hypothesis | Coffee-corner map taste notes guest drink cards and equipment-neutral routines |
| First validation test | Test coffee and tea audiences with separate original samples |

## Original page architecture

- Opening pages: prototype boundary, customer-use orientation, and a product-specific starting map.
- Repeating sequence: **Home-cafe ritual** entry -> **cafe counter** work surface -> return note.
- Closing pages: open notes for the user’s own material.

## Boundary

No caffeine health nutrition or food-safety advice
