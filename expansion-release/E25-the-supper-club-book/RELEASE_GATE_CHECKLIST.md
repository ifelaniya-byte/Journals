...
- [x] Product-specific boundary is documented: No food-safety alcohol service or event-safety advice
...
**Limited 2026-08-31 web-screen result:** **RETITLE BEFORE RELEASE** - Multiple active books use the exact title 'The Supper Club Book'.
