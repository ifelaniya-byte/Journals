...
|---|---|
| Primary niche | small-kitchen living |
| Core customer job | Plan home cooking routines around a compact space |
| Product form under test | 7x9 guided workbook |
| Route in this package | paperback prototype |
| Prototype trim | 7 x 9 in. |
| Prototype pages | 88 |
| Differentiation hypothesis | Pantry-zone map repeat-meal library and guest-with-little-space planner |
| First validation test | Test compact-kitchen audience demand and usability |

## Original page architecture

- Opening pages: prototype boundary, customer-use orientation, and a product-specific starting map.
- Repeating sequence: **Small-kitchen repeat** entry -> **kitchen map** work surface -> return note.
- Closing pages: open notes for the user’s own material.

## Boundary

No nutrition food-safety or dietary advice
