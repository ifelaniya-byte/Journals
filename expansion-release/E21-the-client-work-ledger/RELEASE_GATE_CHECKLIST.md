...
- [x] Product-specific boundary is documented: No tax legal contract pricing or business-results advice
...
**Limited 2026-08-31 web-screen result:** **COUNSEL REVIEW REQUIRED** - Client-ledger uses surfaced in a different functional category; qualified review required.
