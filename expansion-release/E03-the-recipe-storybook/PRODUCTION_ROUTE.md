...
The registered route is **Direct physical heirloom object first; paperback only as a distinct edition**. A generic paperback wrap would misrepresent that decision. The included `E03` interior is a usability and editorial prototype at 8 x 10 in. / 112 pages, and the front cover is a visual concept only.
