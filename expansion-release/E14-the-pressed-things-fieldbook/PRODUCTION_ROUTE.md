...
The registered route is **Direct physical kit first; paperback only with original activity content**. A generic paperback wrap would misrepresent that decision. The included `E14` interior is a usability and editorial prototype at 8 x 10 in. / 96 pages, and the front cover is a visual concept only.
