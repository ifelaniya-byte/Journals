# E14 - release-gate checklist

## Current status

**LOCAL PROTOTYPE PACKAGE - HOLD - NOT FOR SALE, UPLOAD, OR MANUFACTURE**

**Product:** The Pressed Things Fieldbook

**Route:** direct-first physical/printable/B2B prototype
...
- [x] Product-specific boundary is documented: No plant identification for consumption allergy or safety advice
...
**Limited 2026-08-31 web-screen result:** **COUNSEL REVIEW REQUIRED** - No salient exact-title result observed; fieldbook/flower-pressing category uses were observed.

## Route and proof

- [ ] Selected vendor, dieline, materials, assembly, and packaging requirements validated.
...
Select a vendor/physical product path; obtain final dielines and proof criteria before any manufacturing decision.
