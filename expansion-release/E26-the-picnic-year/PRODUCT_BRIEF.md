...
|---|---|
| Primary niche | picnics and low-key outings |
| Core customer job | Plan and remember small outdoor gatherings |
| Product form under test | 7x9 fieldbook |
| Route in this package | paperback prototype |
| Prototype trim | 7 x 9 in. |
| Prototype pages | 80 |
| Differentiation hypothesis | Pack-light checklist place sketch weather note and shared-memory page |
| First validation test | Test one park-day card set and local-outing landing page |

## Original page architecture

- Opening pages: prototype boundary, customer-use orientation, and a product-specific starting map.
- Repeating sequence: **Outdoor day** entry -> **picnic map** work surface -> return note.
- Closing pages: open notes for the user’s own material.

## Boundary

No weather wildlife food-safety or public-land advice
