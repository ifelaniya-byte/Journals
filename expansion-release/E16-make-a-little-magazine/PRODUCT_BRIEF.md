...
|---|---|
| Primary niche | zine making and paper craft |
| Core customer job | Help beginners structure an original small print project |
| Product form under test | 8.5x11 illustrated workbook |
| Route in this package | paperback prototype |
| Prototype trim | 8.5 x 11 in. |
| Prototype pages | 88 |
| Differentiation hypothesis | Issue map foldable prototype exercises and distribution-free project prompts |
| First validation test | Test a four-page project sampler and workshop interest |

## Original page architecture

- Opening pages: prototype boundary, customer-use orientation, and a product-specific starting map.
- Repeating sequence: **Tiny issue** entry -> **zine fold** work surface -> return note.
- Closing pages: open notes for the user’s own material.

## Boundary

No copyright clearance publishing or business advice
