...
- [x] Product-specific boundary is documented: No tool safety structural electrical or textile-preservation advice
...
**Limited 2026-08-31 web-screen result:** **RETITLE BEFORE RELEASE** - A repair/build channel uses the exact title 'Mend and Make'.
