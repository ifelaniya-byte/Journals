...
def build_coloring_book(path, title, subtitle, level, tips, page_count, draw_fn, paper_ppi=WHITE_PPI):
    ...
    copyright_page(c, w, h, title,
        f"{page_count} pages of {level}-level designs. Thick outlines for markers, "
        f"colored pencils, or crayons. Single-sided printing. © {YEAR} {AUTHOR}.")
    pn += 1
...
PRODUCTS = {
    "dump": {
        ...
        "subtitle": "Micro-Journaling for People Who Hate Journaling",
    ...
    "parallel": {
        ...
        "subtitle": "A Side-by-Side Journal for Divided Minds",
    ...
    "night": {
        ...
        "subtitle": "A Journal for When You Can't Sleep",
    ...
    "firststroke": {
        "title": "First Strokes",
        "subtitle": "Super Simple Coloring for Absolute Beginners",
        "trim": COLOR_TRIM, "pages": 100, "paper": "white", "price": "$9.99",
        "dir": "firststroke", "tex_rgb": (235, 140, 82), "tex_seed": 31,
        ...
        "badge": "BEGINNER  ·  100 PAGES  ·  SUPER SIMPLE",
    },
    "garden": {
        "title": "Easy Garden",
        "subtitle": "Simple Botanical Coloring for Relaxation",
        "trim": COLOR_TRIM, "pages": 100, "paper": "white", "price": "$9.99",
        "dir": "garden", "tex_rgb": (92, 142, 78), "tex_seed": 33,
        ...
        "desc": "Sunflowers, tulips, daisies, mushrooms, ladybugs, snails, and bees — all drawn with bold, "
                "forgiving lines. Each page has one main subject with large fill areas. No tiny gaps. "
                "Single-sided. 8.5 × 11 in. 100 pages. A garden that never needs watering.",
    ...
    "mosaic": {
        "title": "Mosaic Mind",
        "subtitle": "Geometric Mosaics & Tessellations for Focused Coloring",
        ...
        "desc": "Hexagonal mosaics, Islamic stars, Celtic knots, op-art circles, chevron fields, and pinwheel "
                "patterns — medium-complexity designs with enough detail to stay engaged without overwhelming. "
                "Single-sided. 8.5 × 11 in. 120 pages. For the coloring sweet spot between too easy and too hard.",
        ...
        "badge": "AMATEUR  ·  120 PAGES  ·  GEOMETRIC PATTERNS",
    },
    "woodland": {
        "title": "Woodland Wonders",
        "subtitle": "Forest Animals & Nature Scenes for Creative Coloring",
        "trim": COLOR_TRIM, "pages": 120, "paper": "white", "price": "$12.99",
        "dir": "woodland", "tex_rgb": (72, 88, 62), "tex_seed": 37,
        ...
        "badge": "AMATEUR  ·  120 PAGES  ·  FOREST CREATURES",
    },
    "fractal": {
        "title": "Fractal Dreams",
        "subtitle": "Complex Mathematical Patterns for Advanced Colorists",
        ...
        "badge": "ADVANCED  ·  140 PAGES  ·  MATHEMATICAL ART",
    },
    "architect": {
        "title": "Architectural Visions",
        "subtitle": "Intricate Buildings & Cityscapes for Detail Lovers",
        "trim": COLOR_TRIM, "pages": 140, "paper": "white", "price": "$14.99",
        "dir": "architect", "tex_rgb": (58, 52, 48), "tex_seed": 41,
        ...
        "desc": "Gothic cathedrals with flying buttresses and rose windows. Dense cityscapes with hundreds of windows. "
                ...
                "you can get lost in. Single-sided. 8.5 × 11 in. 140 pages. For detail lovers who want their coloring "
        ...
        "badge": "ADVANCED  ·  140 PAGES  ·  ARCHITECTURAL DETAIL",
    },
}
...
def main():
    ...
    for key in build_list:
        ...
        generate_wrap(d / f"{prefix}_cover_wrap.pdf", prod["trim"], actual_pages, tex_path,
                      ...
                      prod["desc"][:250], prod["features"], ppi)
